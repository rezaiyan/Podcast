...
public class PersianDatePicker extends LinearLayout {
    ...
    public PersianDatePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (selectedYear > maxYear || selectedYear < minYear) {
            throw new IllegalArgumentException(
                    String.format("Selected year (%d) must be between minYear(%d) and maxYear(%d)", selectedYear,
                            minYear, maxYear));
        }
    ...
    public Date getDisplayDate() {
        ...
        displayPersianDate.setPersianDate(yearNumberPicker.getValue(), monthNumberPicker.getValue(),
